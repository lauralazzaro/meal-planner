...
def upgrade() -> None:
    ...
    op.create_index('uq_one_default_weekly_plan_per_user', 'weekly_plan', ['is_default', 'user_id'], unique=True, postgresql_where=sa.text('is_default = true'))
...
def downgrade() -> None:
    ...
    op.drop_index('uq_one_default_weekly_plan_per_user', table_name='weekly_plan', postgresql_where=sa.text('is_default = true'))
